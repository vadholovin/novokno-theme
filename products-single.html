  ...
  <main class="wrapper">
    <div class="container">
      <ul class="breadcrumbs">
        ...
        <li class="breadcrumbs__item">
          <a class="breadcrumbs__link" href="#">Раздел</a>
        </li>
        <li class="breadcrumbs__item">
          <span class="current">Страница</span>
        </li>
      </ul>
    </div>
          ...
          <div class="grid product__grid">
            <div class="grid__col grid__col-sm-6 product__col product__col-left">
              <div class="product-gallery">
                <div class="swiper-container product-photo js-product-slider" id="">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide product-photo__item">
                      <figure class="product-photo__img">
                        <img class="swiper-lazy" data-src="assets/img/content/product-1.jpg" alt="">
                      </figure>
                    </div>
                    <div class="swiper-slide product-photo__item">
                      <figure class="product-photo__img">
                ...
                <div class="swiper-container product-thumbs js-product-thumbs" id="">
                  <div class="swiper-wrapper">
            ...
            <div class="grid__col grid__col-sm-6 product__col product__col-right">
              <div class="product__heading">
                <h1 class="product__title">Gealan 8000 iq 6k</h1>
                <p class="product__subtitle">Стиль и качество в вашем интерьере</p>
              </div>
              <div class="product-price">
                <div class="product-price__cost">10 100 Р <span class="product-price__cost--small">/ шт.</span>
                </div>
                <div class="product-price__note">Стоимость за окно размером 1300х1400</div>
              </div>
              <div class="product-colors">
                <div class="product-colors__title">Возможные расцветки:</div>
                <ul class="product-colors__list">
                  <li class="product-colors__item" style="background-image: url(assets/img/content/colors/grey.jpg);" data-tippy-content="grey"></li>
                  <li class="product-colors__item" style="background-image: url(assets/img/content/colors/oregon.jpg);" data-tippy-content="oregon"></li>
                  <li class="product-colors__item" style="background-image: url(assets/img/content/colors/tabaco.jpg);" data-tippy-content="tabaco"></li>
                </ul>
              </div>
              ...
              <div class="product-features">
                ...
                <table class="product-features__table">
                  <tbody>
                    ...
                    <tr>
                      <th>Толщина армирования</th>
                      <td>1,5 мм.</td>
                    </tr>
                    <tr>
                      <th>Тип армирования</th>
                      <td>П-образное</td>
                    </tr>
                    <tr>
                      <th>Стеклопакет</th>
                    ...
                    <tr>
                      <th>Коэффициент сопротивления теплопередаче</th>
                      <td>0,79 м2°С/Вт</td>
                    </tr>
                    <tr>
                      <th>Цвет уплотнителя</th>
                      <td>Черный/Серый</td>
                    </tr>
                    <tr>
                      <th>Количество контуров уплотнения</th>
                      <td>2</td>
                    </tr>
                    <tr>
                      <th>Толщина наружных стенок профиля</th>
                      <td> 2,8 мм.</td>
                    </tr>
                    <tr>
                      <th>Класс профиля</th>
